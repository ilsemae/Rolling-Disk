function EOM_sliding_disk_derive() 
    ...
    R1 = [ cos(EulerAngs1) -sin(EulerAngs1) 0;
           sin(EulerAngs1)  cos(EulerAngs1) 0;
           0 0 1];
       
    R2 = [ cos(EulerAngs2) 0  sin(EulerAngs2);
           0 1 0;
    ...
    aG     = (-r*EulerAngsDotDot2*sin(EulerAngs2) - r*EulerAngsDot2^2*cos(EulerAngs2))*e3;
    ...
    rhs_file = fopen('MAE_6700/final_project/sliding_disk_rhs.m','w');
    fprintf(rhs_file,'function qdot = sliding_disk_rhs(tspan,q,flag,p) \n');
    fprintf(rhs_file,' \n');
    %unpacking
